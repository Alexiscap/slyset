...
$searching = (!empty($keyword)) ? $keyword : 'Tous les résultats';
?>
...
<div id="contentAll">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a href="#">Recherche : <?php echo $searching; ?></a></li>
        </ul>
    </div>
    ...
    <div class="content contentAdmin">
        <h2 id="title-dashboard">
            ...
            <?php elseif($nb_results == 1): ?>
                <?php echo $nb_results; ?> résultat de recherche pour "<?php echo $searching; ?>"
            <?php else: ?>
                <?php echo $nb_results; ?> résultats de recherche pour "<?php echo $searching; ?>"
            <?php endif; ?>
        </h2>
