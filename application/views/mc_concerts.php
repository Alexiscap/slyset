  ...
  <div class="content">
    ...
    <h2>Les concerts de Bob Dylan &agrave; venir</h2>
     ...
     <!-- Boucle : tous les concerts pour un artiste -->
   	  <?php foreach($concert_all as $concert_unit): ?>

   
  		 <p  class="date-heure"><span><?php echo $concert_unit->date ?>Mardi 26 Octobre 2013 - 19h30 - <?php echo $concert_unit->prix ?>&euro;</span></p>
   		 ...
   		 <hr/>
   			 ...
   			 <div class="adr_concert">
    	 		...
    	 		<p class="adr_lieu"><?php echo $concert_unit->lieu ?></p>
    ...
    <a href="#" class="more">Cacher les informations</a>
    <a href="#" class="participer"><span class="button_left"></span><span class="button_center">J'y vais</span><span class="button_right"></span></a>
    <div class="info_sup">
