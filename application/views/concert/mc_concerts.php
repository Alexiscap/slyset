...
<div id="contentAll">
    ...
    <div class="content">
        ...
        <h2>Les concerts de <?php echo $login; ?> &agrave; venir</h2>
        ...
        if ($nbr_concert_par_artiste != 0) {
            foreach ($concert_all as $concert_unit):
                ...
                <p id='<?php echo $concert_unit->id; ?>' class="date-heure"><span><?php get_date($concert_unit->date, 'complete'); ?> <?php if (isset($concert_unit->prix)) echo ' - ' . $concert_unit->prix . '&euro;' ?></span>
                </p>
                <?php
