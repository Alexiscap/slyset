...
<div id="contentAll">
    ...
    <div class="content">
        ...
        foreach ($all_media_user_result as $media_user_result_unit):
            ...
            if ($media_user_result_unit->type == 1) {
                ...
                <div onclick="displayHover" class="photo box col1">
                    <!--  edition : HOVER *******************-->
                    <div class="edit">
                        <a href="<?php echo site_url('media/editer/' . $infos_profile->id . '/' . $media_user_result_unit->id . '/' . $media_user_result_unit->type) ?>"><img src="<?php echo img_url('musicien/edite.png'); ?>"/></a>
                        <!--  edition : SUPPRESSION *******************-->

                        <a href="<?php echo site_url('media/supprimer/' . $infos_profile->id . '/' . $media_user_result_unit->id . '/' . $media_user_result_unit->type) ?>"><img src="<?php echo img_url('musicien/suppr.png'); ?>"/></a>
                    </div>
                    <!-- image -->
                    ...
                    <div class="bord_photo">
                        <a onclick='showComment("comm<?php echo $media_user_result_unit->id ?>")' href="javascript:void(0);"><p><?php if ($cpt_comment == 0) echo "0 commentaire"; if ($cpt_comment == 1) echo "1 commentaire"; if ($cpt_comment > 1) echo $cpt_comment . "commentaires" ?></p></a>
                        <?php
                ...
                <div class="photo box col1">
                    ...
                    <!--  edition : HOVER *******************-->
                    <div class="edit">
                        <a href="<?php echo site_url('media/editer/' . $infos_profile->id . '/' . $media_user_result_unit->file_name . '/' . $media_user_result_unit->type) ?>"><img src="<?php echo img_url('musicien/edite.png'); ?>"/></a>
                        <a href="<?php echo site_url('media/supprimer/' . $infos_profile->id . '/' . $media_user_result_unit->file_name . '/' . $media_user_result_unit->type) ?>"><img src="<?php echo img_url('musicien/suppr.png'); ?>"/></a>
                    </div>
                    <div class="open_alb">
                        <a href="<?php echo site_url('media/album/' . $infos_profile->id . '/' . $media_user_result_unit->file_name) ?>"><img src="<?php echo img_url('musicien/open_plus.png'); ?>"/></a>
                    </div>
        ...
        ?>
                    ...
                    <div class="bord_photo">
                        <a onclick='showComment("comm<?php echo $media_user_result_unit->file_name ?>")' href="javascript:void(0);"><p><?php if ($cpt_comment == 0) echo "0 commentaire"; if ($cpt_comment == 1) echo "1 commentaire"; if ($cpt_comment > 1) echo $cpt_comment . "commentaires"; ?></p>
                        </a>
