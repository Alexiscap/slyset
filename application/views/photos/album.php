    		  ...
    		  <div class="allcomment" id="comm<?php echo $media_user_result_unit->id ?>">
                        ...
                        <?php foreach ($commentaires as $commentaire): ?>
                            <?php if ($media_user_result_unit->id == $commentaire->photos_id): ?>      
                                <div class="comm">
                                    <?php  if ($profile->id == $uid) { ?> <img id="<?php echo $commentaire->comm_id ?>" src="<?php echo img_url('common/del.png'); ?>" alt="Suppression" class="del"/>
                                 <?php } ?>   <img src="<?php echo base_url('/files/profiles/'.$commentaire->thumb); ?>" alt="Photo profile"/>
 	...
 	<div class="box col1">
		<div class="photo">
		  <?php if ($profile->id == $uid) { ?> 
            ...
            { ?>
             <img src="<?php echo img_url('musicien/icon_coeur.png'); ?>" id="<?php echo $media_user_result_unit->id ?>" class="like-video" alt="coeur rouge"/>
          ...
          <?php } ?>
    		...
    		<?php foreach($commentaires_video as $commentaire): 
                	...
                	<div class="comm">
                	 <?php if ($profile->id == $uid) { ?>
						<img id="<?php echo $commentaire->comm_id ?>" src="<?php echo img_url('common/del.png'); ?>" class="del" alt="Suppression"/><?php } ?>
