...
<div id="first-line">
  <div id="first-line-top-song">
    ...
    <div id="top-song-play">
      <table cellpadding="0">
        <tr class="white"><td class="top-number">1</td><td class="top-title">Blowin The Wind</td><td class="top-number">6</td><td class="top-title">In The City</td></tr>
        <tr class="grey"><td class="top-number">2</td><td class="top-title">Hurricane<p class="top-artist">Bob Dylan</p></td><td class="top-number">7</td><td class="top-title">Late Night</td></tr>
        <tr class="white"><td class="top-number">3</td><td class="top-title">Zebra</td><td class="top-number">8</td><td class="top-title">Lay, Lady, Lay</td></tr>
        <tr class="grey"><td class="top-number">4</td><td class="top-title">Jersey</td><td class="top-number">9</td><td class="top-title">Pretty Pegy</td></tr>
        <tr class="white"><td class="top-number">5</td><td class="top-title">Hard Time in New...</td><td class="top-number">10</td><td class="top-title">Hello, I love you</td></tr>
      </table>
    </div>
  </div>
  ...
  <div id="first-line-newbies">
    ...
    <div id="newbies-content">
    <p><img src="<?php echo img_url('sidebar-left/photo-profil.png') ?>" alt="Photo Profil" /></p>
    <p><img src="<?php echo img_url('sidebar-left/photo-profil.png') ?>" alt="Photo Profil" /></p>
    <p><img src="<?php echo img_url('sidebar-left/photo-profil.png') ?>" alt="Photo Profil" /></p>
    <p><img src="<?php echo img_url('sidebar-left/photo-profil.png') ?>" alt="Photo Profil" /></p>
    </div>
...
>>>>>>> 389b31b386a08cfeffa602ac02fd46ad9bf5b4af
