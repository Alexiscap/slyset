    ...
    <aside>
        ...
        <div id="menu-account">
            <ul>
                ...
                <li class="row row-3"><a href="<?php print site_url('mes-achats/'.$this->session->userdata('uid'))?>"><span class="icon"></span><span class="menu-text">Mes achats</span></a></li>
          ...
          if(($this->session->userdata('account') == 2 || $this->session->userdata('account') == 0) && ($user_id == $this->session->userdata('uid'))): ?>
            ...
            <div id="menu-profile" class="active">
                <ul>
                    ...
                    <li class="row row-9"><a href="<?php print site_url('mc_concerts/'.$user_id); ?>"><span class="icon"></span><span class="menu-text">Concerts</span></a></li>
