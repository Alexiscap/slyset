            ...
            <?php if ($user_info->type != 1): ?>
                <div id="menu-profile" class="active">
                    <ul>
                        ...
                        <li class="row row-14"><a href="<?php print site_url('follower/' . $user_id); ?>"><span class="icon"></span><span class="menu-text">Abonnés</span></a></li>
                    </ul>
                </div>
            <?php else: ?>
                <div id="menu-profile" class="active">
                    <ul>
                        <li class="head_menu row row-7"><a href="<?php print site_url('home/' . $user_id); ?>"><span class="icon"></span><span class="menu-text"><?php print $user_info->login; ?></span></a></li>
                        <li class="first-row row row-8"><a href="<?php print site_url('my-wall/' . $user_id); ?>"><span class="icon"></span><span class="menu-text">Actualités</span></a></li>
                        <li class="row row-9"><a href="<?php print site_url('my-concert/' . $user_id); ?>"><span class="icon"></span><span class="menu-text">Concerts</span></a></li>
                        <li class="row row-10"><a href="<?php print site_url('my-playlist/' . $user_id); ?>"><span class="icon"></span><span class="menu-text">Playlist</span></a></li>
                        <li class="row row-14"><a href="<?php print site_url('my-follower/' . $user_id); ?>"><span class="icon"></span><span class="menu-text">Abonnements</span></a></li>
                    </ul>
                </div>
            <?php endif; ?>
        <?php endif; ?>
