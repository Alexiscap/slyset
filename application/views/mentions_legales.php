...
<div id="contentAll">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a href="<?php echo site_url($this->uri->segment(1) . '/' . $session_id); ?>">Mentions légales</a></li>
        </ul>
    </div>

    <div class="content_static">
        <h2 class="page_static">Mentions légales</h2>
        <p class="titre_mention">1. Présentation du site.</p>
        <br />
        <p class="txt_mention">
        ...
        <br />
        <p class="titre_mention">2. Conditions générales d’utilisation du site et des services proposés.</p>
        <br />
        <p class="txt_mention">
        ...
        <br />
        <p class="titre_mention">3. Description des services fournis.</p>
        <br />
        <p class="txt_mention">
        ...
        <br />
        <p class="titre_mention">4. Propriété intellectuelle et contrefaçons.</p>
        <br />
        <p class="txt_mention">
