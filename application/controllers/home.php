...
//        }        
        ...
        {
     //   var_dump ($data['concert_date_uniq']);
            ...
            //  echo  $data['concert_date_uniq']->date."<pre>";
              ...
              else
              {
               ...
               //var_dump(getdate());
                ...
                $data['all_date_calendar']   .= 
            	$data['format_date_calendar'] =  '{ Title:"Concert du '.$data['concert_date_uniq']->date.'</br><a href='.$link.'> '.$data['concert_date_uniq']->titre.' & '.$data['concert_date_uniq']->seconde_partie.' </a> </br> '.$data['concert_date_uniq']->salle.' - '.$data['concert_date_uniq']->ville.'", Date: new Date("'.$data['evenement'][1].'/'.substr($data['evenement'][2],0,2).'/'.$data['evenement'][0].'") },';
				//print $data['format_date_calendar'];
