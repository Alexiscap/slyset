...
class Mc_musique extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->setPath_img_upload_folder("assets/images/articles/");
        $this->setPath_img_thumb_upload_folder("assets/images/articles/thumbnails/");

        //Delete img url
        $this->setDelete_img_url(base_url() . 'assets/images/common/delete/');

        //Set url img with Base_url()
        $this->setPath_url_img_upload_folder(base_url() . "assets/images/articles/");
        $this->setPath_url_img_thumb_upload_folder(base_url() . "assets/images/articles/thumbnails/");
