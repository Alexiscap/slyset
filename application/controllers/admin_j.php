...
class Admin_j extends CI_Controller {
...
//Set relative Path with CI Constant
        $this->setPath_img_upload_folder("./files/test/articles/");
        $this->setPath_img_thumb_upload_folder("./files/test/articles/thumbnails/");

        
//Delete img url
        $this->setDelete_img_url(base_url() . './files/test/admin/delete/');
...
// remplacer les caracteres autres que lettres, chiffres et point par _
        ...
        $config['allowed_types'] = 'gif|jpg|png|JPG|GIF|PNG|pdf';
